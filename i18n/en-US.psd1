...
@{
    ...
    'ui.select.locked.hidden'                = '(hidden {0} locked)'
    ...
    'scoop.mirror.repo.pending'              = 'SCOOP_REPO is not set in scoop config; mirror switch may fail'
    'scoop.mirror.done'                      = 'scoop mirror switched'
    'scoop.config.setting'                   = 'scoop config {0} = {1}'
    ...
    'scoop.app.uninstall.fail'               = '{0} uninstall failed: {1}'
    'scoop.app.uninstall.still'              = '{0} uninstall incomplete: {1}'
    'scoop.app.migrate.fail'                 = '{0} migration failed: {1}'
    'scoop.app.migrate.incomplete'           = '{0} migration incomplete: {1}'
    ...
    'links.glob.no.match'                    = 'Dotfiles glob matched no files, skipping: {0}'
    'links.glob.dest.mismatch'               = 'Dotfiles Dest must include globs matching Src: {0}'
    'links.glob.star.mismatch'               = 'Dotfiles Src/Dest have different * counts: {0} → {1}'
    ...
    'summary.status.group.migrate.ok'        = '--- Migration succeeded ---'
    'summary.status.group.migrate.fail'      = '--- Migration failed ---'
    'summary.block.pkgmgr'                   = 'Package manager'
    'summary.block.packages'                 = 'scoop packages'
    'summary.block.migrate'                  = 'scope migration'
    'summary.block.config'                   = 'Config files'
    'summary.block.chezmoi'                  = 'chezmoi'
    'summary.label.mirror'                   = 'gitee mirror'
    'summary.label.scoop.config'             = 'scoop config'
    ...
    'summary.detail.scoop.config.none'       = 'no SetConfig entries, skipping'
    'summary.detail.scoop.config.skip'       = 'scoop config already up to date, skipping'
    'summary.detail.scoop.config.ok'         = 'applied {0} scoop config entries'
    ...
    'summary.detail.migrate.fail'            = 'migration failed'
    'summary.detail.app.uninstall.fail'      = 'uninstall failed'
    'summary.detail.app.uninstall.still'     = 'uninstall incomplete, package still in current scope'
    'summary.detail.migrate.incomplete'      = 'migration incomplete, package still in current scope'
    ...
    'summary.done.with_migrate'              = 'Done: {0} succeeded  {1} skipped  {2} failed  |  Migration: {3} succeeded  {4} failed'
    'summary.done.uninstall'                 = 'Done: {0} uninstalled  {1} skipped  {2} failed'
    'summary.log'                            = 'Detailed log: {0}'
    'summary.hint'                           = 'Next: use windots in a new terminal (init, install, uninstall, update, migrate, clean, link, harvest, doctor, cd)'
    ...
    'interactive.step.scoop.paths'           = '--- Scoop install paths ---'
    'interactive.scoop.paths.missing'        = 'Scoop.SetConfig in settings.psd1 is missing root_path or global_path: {0}'
    'interactive.scoop.paths.hint'           = 'Edit the file above and set ROOT_PATH and GLOBAL_PATH under Scoop.SetConfig, then return here.'
    'interactive.scoop.paths.ready.prompt'   = 'Paths configured. Continue initialization?'
    'interactive.scoop.paths.review'         = 'Scoop install paths in settings.psd1:'
    'interactive.scoop.paths.confirm.prompt' = 'Continue with these paths?'
    ...
    'ui.select.tree.hint.move'               = '  J/K(↓/↑) Move  D/U(→/←) Jump Group  Shift+D/U Bottom/Top Group  F Fold/Unfold  Shift+F Fold/Unfold All  H Hide/Show'
    ...
    'interactive.plan.scoop.path.unset'      = '(not configured)'
    'interactive.plan.scoop.repo'            = 'scoop mirror : {0}'
    'interactive.plan.scoop.repo.unset'      = '(not configured)'
    'interactive.plan.scoop.repo.official'   = 'official source'
    ...
    'init.step.scoop.config'                 = '--- Applying scoop config ---'
    ...
    # --- 反向回收 ---
    'harvest.title'                          = '=== windots harvest ==='
    'harvest.confirm'                        = 'Harvest {0} runtime config file(s) back into dotfiles (will overwrite uncommitted changes). Continue?'
    'harvest.nothing'                        = 'Nothing to harvest: all configs are up-to-date or still correctly linked'
    'harvest.skip.linked'                    = 'still correctly linked, skipping: {0}'
    'harvest.skip.nodest'                    = 'not found, skipping: {0}'
    'harvest.skip.unchanged'                 = 'content identical, skipping: {0}'
    'harvest.skip.dir'                       = 'Src is a directory, skipping: {0}'
    'harvest.done'                           = 'harvested: {0} -> {1}'
    'harvest.plan'                           = '[WhatIf] would harvest: {0} -> {1}'
    ...
    'setup.cmd.hint'                         = 'Available commands: init, install (i), uninstall (rm), update (up), migrate, clean, link, harvest (hv), doctor, cd'
