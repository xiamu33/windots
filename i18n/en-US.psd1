...
@{
    ...
    'summary.group.ok'                   = 'Installed: {0}'
    'summary.group.skip'                 = 'Already installed, skipping: {0}'
    'summary.group.fail'                 = 'Install failed:'
    ...
    'summary.col.config'                 = 'Config'
    'summary.section.scoop'              = '--- Install scoop ---'
    'summary.section.mirror'             = '--- scoop mirror ---'
    'summary.section.packages'           = '--- Install scoop packages ---'
    'summary.section.config'             = '--- Apply config files ---'
    'summary.section.chezmoi'            = '--- Initialize chezmoi ---'
